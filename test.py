...
def main():
    ...
    OrderCity = st.selectbox("10.OrderCity",("Bekasi","Bikaner"))
    Order_Country = st.selectbox("11.Order Country",("India","China"))
    ...
    OrderRegion = st.selectbox("19.OrderRegion",("Central","America"))
    OrderState = st.selectbox("20.OrderState",("Queensland","Tokio"))
    OrderStatus = st.selectbox("21.OrderStatus",("COMPLETE","PENDING"))
    ShippingMode = st.selectbox("22.ShippingMode",("First Class","Standard Class"))
